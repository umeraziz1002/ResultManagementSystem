...
namespace ResultManagementSystem.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Enrollments.Include(e => e.CourseOffering).Include(e => e.Student);
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentId,CourseOfferingId,IsCompleted")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentId,CourseOfferingId,IsCompleted")] Enrollment enrollment)
        {
            if (id != enrollment.Id)
            {
                return NotFound();
